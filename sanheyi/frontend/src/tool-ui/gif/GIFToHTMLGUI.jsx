    ...
    <div className="tool-container-full">
      ...
      <div style={{ marginBottom: '16px', padding: '0 40px', marginTop: '12px' }}>
        <div className="tool-breadcrumbs">
          ...
          <span style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ margin: '0 8px', color: 'var(--text-secondary)' }}>/</span>
            <span className="current">GIF To HTML</span>
          </span>
        </div>
        <div className="header-text" style={{ marginTop: '12px' }}>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
             ...
             <h1 className="header-title" style={{ fontSize: '24px', fontWeight: '600', margin: 0 }}>{t("GIF To HTML 转换器")}</h1>
           </div>
           <div className="header-desc" style={{ fontSize: '14px', paddingLeft: '44px', color: 'var(--text-secondary)' }}>{t("\u2014\u2014 将 GIF 动图以 Base64 编码方式嵌入到 HTML 页面中，实现单文件分发，方便在任何浏览器中查看。")}</div>
        </div>
      </div>
      ...
      <div className="tool-content-scroll">
        <div className="tool-main-layout video-converter-layout">
          ...
          <div className="tool-right-panel">
            <SettingsPanel title={t("功能说明")}>
              <div style={{ padding: '10px', color: '#666', fontSize: '14px' }}>{t("将 GIF 动图以 Base64 编码方式嵌入到 HTML 页面中，实现单文件分发，方便在任何浏览器中查看。")}
      ...
      <ConfirmationModal
        ...
        title={t("确认取消")}
        message={t("确定要取消当前的转换任务吗？未完成的文件将被删除。")}
