      ...
      <div style={{ marginBottom: '16px', padding: '0 40px', marginTop: '12px' }}>
        ...
        <div className="header-text" style={{ marginTop: '12px' }}>
           <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
             ...
             <h1 className="header-title" style={{ fontSize: '24px', fontWeight: '600', margin: 0 }}>{t("MOV To WAV 转换器")}</h1>
           </div>
           <div className="header-desc" style={{ fontSize: '14px', paddingLeft: '44px', color: 'var(--text-secondary)' }}>{t("\u2014\u2014 从 MOV 视频中提取无损 WAV 音频，支持批量转换和音频设置。")}</div>
        </div>
      </div>
        ...
        <div className="tool-main-content video-converter-layout">
          ...
          <div className="tool-right-panel">
            <SettingsPanel title={t("转换选项")}>
              ...
              <div className="setting-info-box" style={{ marginTop: '12px', padding: '10px', backgroundColor: '#f0f9ff', borderRadius: '6px', fontSize: '12px', color: '#0369a1', border: '1px solid #bae6fd' }}>{t("提示：WAV 格式将采用无损 PCM (S16LE) 编码，提供最高保真度。")}
