...
class PNGToPSDConverter(BaseConverter):
    """PNG到PSD转换器（单层输出）"""
        ...
        try:
            ...
            with Image.open(input_path) as img:
                ...
                channels = {
                    ...
                    ChannelId.transparency: img_array[:, :, 3]
                }
                ...
                rgb_channels = np.transpose(img_array[:, :, :3], (2, 0, 1))
            ...
            raise Exception(f"PNG to PSD conversion failed: {str(e)}")
