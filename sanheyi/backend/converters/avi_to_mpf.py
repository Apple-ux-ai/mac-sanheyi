...
class AVIToMPFConverter(BaseConverter):
    ...
    def convert(self, input_path: str, output_dir: str, **options) -> dict:
        """
        Convert AVI to MPF (MPEG-1 Program Stream)
        """
        try:
            ...
            # Video encoding settings for MPF (MPEG-1)
            ...
            # Audio encoding settings for MPF (MP2)
            if has_audio:
            ...
            command.extend(['-f', 'mpeg']) # MPEG-1 Program Stream
